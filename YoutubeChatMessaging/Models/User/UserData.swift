...
let currentUserData:UserResponse = UserResponse(id: UUID(), name: "Jane Smith", profileUrl: "https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg?auto=compress&cs=tinysrgb&w=600")

let userData:[UserResponse] = [
  UserResponse(id: UUID(), name: "John Doe", profileUrl: "https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?auto=compress&cs=tinysrgb&w=600"),
  ...
  UserResponse(id: UUID(), name: "+1 111 481 8211", profileUrl: "https://images.pexels.com/photos/1040880/pexels-photo-1040880.jpeg?auto=compress&cs=tinysrgb&w=600"),
